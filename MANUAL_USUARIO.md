# Manual de Usuario - Control de Horas Penosas

Bienvenido a la herramienta de gestión de Horas Penosas. Esta aplicación ha sido diseñada para facilitar el registro diario de tus tareas y permitir la generación automática de informes mensuales en formato Excel.

## 1. Acceso a la Aplicación

![Acceso a la aplicación](docs/assets/manual/01_login.png)

Para acceder, utiliza la URL proporcionada por el administrador (ej: `https://penosas.fqdev.eu`).

1.  Introduce tu **nombre de usuario** (habitualmente tu correo electrónico).
...
![Panel de control principal](docs/assets/manual/02_dashboard.png)
...
![Gráfico de barras de evolución](docs/assets/manual/04_chart.png)
Un gráfico de barras que muestra tus horas registradas mes a mes. Puedes alternar la vista entre **Horas** totales o **Euros** (estimación según la base anual).

### C. Nueva Entrada (Registro de Horas)
![Formulario de registro de horas](docs/assets/manual/03_form.png)
...
![Listado de entradas y botón de exportación](docs/assets/manual/05_list.png)
...
![Página de perfil y cambio de contraseña](docs/assets/manual/06_profile.png)
...
## 5. Soporte y Consejos

*   **Uso en Móvil**: La aplicación es totalmente responsiva. Puedes usarla desde el navegador de tu teléfono y se adaptará para que sea cómodo marcar las horas al terminar el turno.
*   **Caché**: Si notas que los cambios de estilo no se aplican, realiza una recarga forzada de la página en tu navegador.

---
*Manual generado el 16 de enero de 2026.*
